...
import 'package:jcbls_app/util/printerenum.dart';
...
class TestPrint {
  ...
  sample() async {
    ...
    ByteData bytesData = await rootBundle.load("images/12.jpg");
    ...
    ///image from Asset
    ByteData bytesAsset = await rootBundle.load("images/12.jpg");
    Uint8List imageBytesFromAsset = bytesAsset.buffer
        .asUint8List(bytesAsset.offsetInBytes, bytesAsset.lengthInBytes);

    ///image from Network
    // var response = await http.get(Uri.parse(
    //     "http://172.105.20.13:3006/uploads/inbound_file/file/216/6.jpg"));
    ...
    bluetooth.isConnected.then((isConnected) {
      if (isConnected == true) {
        ...
        // // bluetooth.printNewLine();
        // bluetooth.printCustom("中国", Size.bold.val, Align.center.val,
        //     charset: "windows-1250");
        // bluetooth.printNewLine();
